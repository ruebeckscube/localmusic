...
class SimilarityScoreTests(TestCaseHelpers):
    ...
    def test_no_searched_mbids(self):
        create_musicbrainz_artist_t('123', 'mb 123' , {'456': .7})
        artist = create_artist_t(similar_musicbrainz_artists=['123'])
    ...
    def test_scoring(self):
        ...
        create_musicbrainz_artist_t('789', 'mb 789' , {'888': .9})
        artist = create_artist_t(similar_musicbrainz_artists=['123', '456'])
...
class SaveTests(TestCaseHelpers):
    ...
    def test_blank_listen_links(self):
        links=""
        artist = create_artist_t(listen_links=links)
    ...
    def test_blank_youtube_links(self):
        links=""
        artist = create_artist_t(youtube_links=links)
