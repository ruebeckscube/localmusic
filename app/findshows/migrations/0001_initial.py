    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('youtube_links', models.TextField(blank=True, help_text='(Optional) Enter up to two youtube links on separate lines.', max_length=300, null=True)),
